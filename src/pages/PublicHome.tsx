...
const PublicHome = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 px-4 md:px-6 bg-gradient-to-br from-orange-300 to-orange-400">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Top Products</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-1">Samosa</h3>
              ...
              <p className="text-sm text-gray-600 mb-4 flex-1">
                Crispy, golden pastry filled with spiced potatoes, peas, and aromatic herbs. A classic comfort snack.
              </p>
              <div className="flex items-center justify-between">
                <span className="font-bold text-primary text-lg">₦2,000</span>
                <Button 
                  size="sm" 
                  onClick={() => handleAddToCart({
                    ...
                    name: 'Samosa',
                    price: 2000,
                    image: 'https://oknnklksdiqaifhxaccs.supabase.co/storage/v1/object/public/product-images/product-1754133371152-phb7rayxvkn.jpg'
                  })}
                >
                  Add to Cart
                </Button>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
              <div className="flex items-start gap-4 mb-4">
                ...
                />
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-1">Wings & Things</h3>
                  <div className="flex items-center mb-2">
                    {renderStars(4.8)}
                    <span className="text-sm text-gray-500 ml-2">(85)</span>
                  </div>
                </div>
              </div>
              <p className="text-sm text-gray-600 mb-4 flex-1">
                Perfectly seasoned chicken wings served with our signature dipping sauce. Crispy outside, juicy inside.
              </p>
              <div className="flex items-center justify-between">
                <span className="font-bold text-primary text-lg">₦5,500</span>
                <Button 
                  size="sm" 
                  onClick={() => handleAddToCart({
                    id: 'wings-1',
                    name: 'Wings & Things',
                    price: 5500,
                    image: 'https://oknnklksdiqaifhxaccs.supabase.co/storage/v1/object/public/product-images/1754132195844-images_1_.jpeg'
                  })}
                >
                  Add to Cart
                </Button>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col">
              <div className="flex items-start gap-4 mb-4">
                ...
                />
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 mb-1">Spring Rolls</h3>
                  <div className="flex items-center mb-2">
                    {renderStars(4.3)}
              ...
              <p className="text-sm text-gray-600 mb-4 flex-1">
                Fresh vegetables wrapped in delicate rice paper, served with our house-made peanut dipping sauce.
              </p>
              <div className="flex items-center justify-between">
                ...
                <Button 
                  ...
                  onClick={() => handleAddToCart({
                    ...
                    name: 'Spring Rolls',
                    price: 3000,
                    image: '/lovable-uploads/8dfaab0f-8bc9-434a-ba8b-158885d43565.png'
                  })}
                >
                  Add to Cart
                </Button>
