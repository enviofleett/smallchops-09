-- Secure functions with search_path to prevent hijacking
-- Fixing create_order_with_items to include SET search_path = 'public'
...
BEGIN
    ...
    -- Use sequence for atomic increment and race condition safety
    SELECT nextval('order_number_seq') INTO v_sequence_num;
