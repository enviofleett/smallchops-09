...
export function safeOrder(order: any): Order | null {
  ...
  try {
    return {
      ...
      total_amount: isNaN(Number(order.total_amount)) ? 0 : Number(order.total_amount),
      ...
      subtotal: order.subtotal !== undefined ? (isNaN(Number(order.subtotal)) ? 0 : Number(order.subtotal)) : undefined,
      tax_amount: order.tax_amount !== undefined ? (isNaN(Number(order.tax_amount)) ? 0 : Number(order.tax_amount)) : undefined,
      delivery_fee: order.delivery_fee !== undefined ? (isNaN(Number(order.delivery_fee)) ? 0 : Number(order.delivery_fee)) : undefined,
      discount_amount: order.discount_amount !== undefined ? (isNaN(Number(order.discount_amount)) ? 0 : Number(order.discount_amount)) : undefined,
      vat_rate: order.vat_rate !== undefined ? (isNaN(Number(order.vat_rate)) ? 0 : Number(order.vat_rate)) : undefined,
      vat_amount: order.vat_amount !== undefined ? (isNaN(Number(order.vat_amount)) ? 0 : Number(order.vat_amount)) : undefined,
