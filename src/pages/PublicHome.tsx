            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
                    ...
                    <h3 className="text-xl font-bold text-red-600 mb-4">Categories</h3>
                     <div className="space-y-2">
                      ...
                      {categories.map(category => (
                        <button key={category.id} onClick={() => navigate(`/category/${category.id}`)} className={`w-full text-left px-4 py-2 rounded-lg transition-colors ${activeCategory === category.id ? 'bg-red-600 text-white' : 'hover:bg-gray-100 text-gray-700'}`}>
                          {category.name}
                        </button>
                      ))}
                    </div>
              ...
              <div className="lg:hidden col-span-full mb-6">
                ...
                <div className="flex space-x-3 overflow-x-auto pb-3 px-2">
                  ...
                  {categories.map(category => (
                    <button key={category.id} onClick={() => navigate(`/category/${category.id}`)} className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-medium transition-colors ${activeCategory === category.id ? 'bg-red-600 text-white' : 'bg-white text-gray-700 border border-gray-200'}`}>
                      {category.name}
                    </button>
                  ))}
                </div>
              ...
              <div className="col-span-full lg:col-span-3">
                ...
                {isLoadingProducts ? (
                  ...
                  <div className="text-center py-8 sm:py-12">
                    ...
                    {(searchTerm || filters.onlyPromotions || filters.priceRange[0] > priceRange[0] || filters.priceRange[1] < priceRange[1] || filters.minRating > 0) && (
                      <Button onClick={() => {
                        setSearchTerm('');
                        setFilters({
                          priceRange: priceRange,
