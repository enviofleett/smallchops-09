...
-- Update any existing records that might have null menu_section
UPDATE public.user_permissions 
SET menu_section = 'general'
...
INSERT INTO audit_logs (
  ...
  'Fixed user_permissions table schema - made menu_section nullable for production compatibility',
  auth.uid(),
  jsonb_build_object(
    'table', 'user_permissions',
    'change', 'menu_section_made_nullable',
    'reason', 'support_menu_key_based_permissions'
  )
);