-- =====================================================
-- SAFE PAYMENT STATUS PROPAGATION - COMPATIBLE IMPLEMENTATION (FIXED POLICY SYNTAX)
-- =====================================================
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' AND tablename = 'system_logs' AND policyname = 'Admins can view system logs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'public' AND tablename = 'system_logs' AND policyname = 'Service role can insert logs'
  ) THEN
