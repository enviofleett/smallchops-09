          ...
          <div className="w-full overflow-hidden rounded-lg bg-background">
            <Calendar 
              ...
              classNames={{
                ...
                head_row: "flex mb-2",
                head_cell: "text-muted-foreground rounded-md w-full max-w-10 font-medium text-xs sm:text-xs uppercase tracking-wide py-1 sm:py-2 text-center",
                row: "flex w-full mt-1",
                cell: "relative p-0 text-center focus-within:relative focus-within:z-20 w-full max-w-8 sm:max-w-10",
                day: cn(
                  ...
                  "focus:bg-accent focus:text-accent-foreground focus:outline-none focus:ring-1 sm:focus:ring-2 focus:ring-primary focus:ring-offset-1 sm:focus:ring-offset-2",
