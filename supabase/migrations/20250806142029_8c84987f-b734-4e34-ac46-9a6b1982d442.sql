-- Fix the create_order_with_items function to match the actual order_items table schema
...
BEGIN
  ...
  -- Insert order items (FIXED: Remove created_at and add product_name)
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items)
  LOOP
