-- Clean Slate Fix: Drop ALL function versions and create definitive version

-- Step 1: Nuclear Option - Remove ALL Function Versions
DO $$
DECLARE
    func_record RECORD;
BEGIN
    -- Get all functions with this name and drop them
    FOR func_record IN 
        SELECT 
    ...
    LOOP
        EXECUTE func_record.drop_command;
        RAISE NOTICE 'Dropped function: %', func_record.drop_command;
    END LOOP;
END $$;

-- Step 2: Create the definitive function version that matches Edge function call
