...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_orders_customer_email_status ON orders(customer_email, status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_orders_customer_id_created_at ON orders(customer_id, created_at DESC);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_order_items_order_product ON order_items(order_id, product_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_products_category_available ON products(category, is_available);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_order_delivery_schedule_order_id ON order_delivery_schedule(order_id);
