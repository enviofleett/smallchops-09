-- Remove legacy email processing triggers and functions (with correct column reference)
...
-- Clean up any orphaned email processing records (using correct column name)
