-- Safe Delivery Zones Reset Migration (Fixed)
...
INSERT INTO delivery_zones (id, name, description, area, created_at)
VALUES 
  (gen_random_uuid(), 'Lagos Island', 'Central Lagos Island including VI, Ikoyi, and Lekki', '{}', NOW()),
  (gen_random_uuid(), 'Lagos Mainland', 'Lagos Mainland areas including Ikeja, Surulere, and Yaba', '{}', NOW()),
  (gen_random_uuid(), 'Lekki Peninsula', 'Lekki Peninsula including Ajah, VGC, and environs', '{}', NOW()),
  (gen_random_uuid(), 'Ikeja GRA', 'Government Reserved Area Ikeja and surrounding areas', '{}', NOW()),
  (gen_random_uuid(), 'Victoria Island', 'Victoria Island business and residential district', '{}', NOW()),
  (gen_random_uuid(), 'Ikoyi', 'Ikoyi residential and business area', '{}', NOW()),
  (gen_random_uuid(), 'Surulere', 'Surulere and adjacent areas', '{}', NOW()),
  (gen_random_uuid(), 'Yaba', 'Yaba technology district and surroundings', '{}', NOW()),
  (gen_random_uuid(), 'Gbagada', 'Gbagada and nearby areas', '{}', NOW()),
  (gen_random_uuid(), 'Ajah', 'Ajah and Sangotedo areas', '{}', NOW());
