-- SAFE RE-RUNNABLE MIGRATION: triggers, indexes, view, RLS, realtime, cron
...
-- 8) Cron schedule (every 5 minutes)
DO $$
BEGIN
  PERFORM cron.unschedule('reconcile-payments-every-5-mins');
