-- Fix missing fulfillment_type enum
-- Create the fulfillment_type enum if it doesn't exist
DO $$ BEGIN
...
-- Update the create_order_with_items function to handle the enum properly
...
BEGIN
  ...
  -- Insert order with proper enum casting
  INSERT INTO orders (
    customer_id,
    order_number,
    fulfillment_type,
