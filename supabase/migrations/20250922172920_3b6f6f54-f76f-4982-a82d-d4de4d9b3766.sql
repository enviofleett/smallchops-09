-- Fix the guest_session_id UUID constraint by handling the dependent view
-- First drop the dependent view
DROP VIEW IF EXISTS app.orders_with_payment;

-- Now update the orders table to allow text guest_session_id  
ALTER TABLE orders ALTER COLUMN guest_session_id TYPE TEXT;

-- Recreate the view if needed (assuming it was similar to a standard orders view)
