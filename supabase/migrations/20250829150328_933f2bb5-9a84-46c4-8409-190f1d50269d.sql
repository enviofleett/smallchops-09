-- Fix enum casting in verify_and_update_payment_status function
...
BEGIN
  ...
  CASE v_effective_status
    ...
    WHEN 'dispatched' THEN v_order_status := 'dispatched'::order_status;
    WHEN 'delivered' THEN v_order_status := 'delivered'::order_status;
    WHEN 'cancelled' THEN v_order_status := 'cancelled'::order_status;
    WHEN 'failed' THEN v_order_status := 'failed'::order_status;
    ELSE v_order_status := 'confirmed'::order_status;
  END CASE;
