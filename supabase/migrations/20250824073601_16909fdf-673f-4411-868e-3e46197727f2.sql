-- Production Email System Migration: Fix template types and ensure core templates
-- Step 1: Ensure all critical email templates exist using valid template_type
...
-- SMTP Test Template (using transactional type)
...
-- Step 2: Deactivate duplicate templates to prevent production confusion
