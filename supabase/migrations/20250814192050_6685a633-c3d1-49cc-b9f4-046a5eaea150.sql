...
-- Recreate the orders_with_payment view without SECURITY DEFINER
...
SELECT 
  ...
  pt.gateway_response->>'channel' as payment_channel
FROM orders o
...
-- Revoke direct access to sensitive business settings for non-admins
-- (Keep admin access via RLS policies)

-- 4. Enhanced email delivery security
