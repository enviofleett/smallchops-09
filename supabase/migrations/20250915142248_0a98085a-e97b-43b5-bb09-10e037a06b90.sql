-- Phase 1: Fix authentication and email system issues
...
-- 4. Clear old failed events that are blocking the queue (older than 24 hours)
...
UPDATE communication_events 
SET status = 'queued', retry_count = 0, updated_at = NOW()
