-- Fix email templates with correct column names
INSERT INTO enhanced_email_templates (template_key, name, html_body, variables, is_active, created_at, updated_at)
VALUES 
