...
BEGIN
    ...
    EXCEPTION 
        WHEN invalid_text_representation THEN
            RAISE EXCEPTION 'Invalid fulfillment type: %. Allowed values are: delivery, pickup' 
                USING ERRCODE = 'P0001';
        WHEN OTHERS THEN
            RAISE EXCEPTION 'Error validating fulfillment type %: %', p_fulfillment_type, SQLERRM 
                USING ERRCODE = 'P0001';
    END;
