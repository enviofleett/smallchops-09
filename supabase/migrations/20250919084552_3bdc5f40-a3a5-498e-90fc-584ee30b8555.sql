-- CRITICAL PRODUCTION FIX: Communication Events Deduplication (Corrected)
...
-- Step 6: Add performance index on dedupe_key (without time filter for immutability)
CREATE INDEX IF NOT EXISTS idx_comm_events_dedupe_key 
