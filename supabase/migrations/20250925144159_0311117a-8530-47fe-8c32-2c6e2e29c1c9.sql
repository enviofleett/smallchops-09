-- Create comprehensive order fulfillment data function
    ...
    v_result := jsonb_build_object(
        ...
        'fulfillment_info', jsonb_build_object(
            ...
            'booking_window', CASE 
                ...
                WHEN v_order.pickup_time IS NOT NULL THEN v_order.pickup_time
                ELSE NULL
            END,
            'delivery_hours', CASE 
            ...
            END,
            'address', CASE 
                WHEN v_order.order_type = 'delivery' THEN v_order.delivery_address
