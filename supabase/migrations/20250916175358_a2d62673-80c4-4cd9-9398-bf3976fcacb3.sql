-- Fix the remaining order_type column casting in get_detailed_order_with_products function
-- This addresses the RPC error "Returned type order_type does not match expected type text in column 6"
