-- Create smtp_delivery_logs table for tracking email delivery
...
CREATE INDEX IF NOT EXISTS idx_smtp_delivery_logs_template_key ON public.smtp_delivery_logs(template_key);