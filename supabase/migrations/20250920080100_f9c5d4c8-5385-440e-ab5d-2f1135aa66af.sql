-- Fix stuck cache entries and enhance cleanup functionality
...
-- Enhance the cleanup function with better logic
...
BEGIN
  ...
  VALUES (
    ...
    'System Maintenance',
    'Cleaned up stuck cache entries',
    jsonb_build_object(
...
-- Create a function specifically for checking if admin is lock holder for an order
...
-- Enhanced cache idempotent request function that allows lock holders to bypass cache
