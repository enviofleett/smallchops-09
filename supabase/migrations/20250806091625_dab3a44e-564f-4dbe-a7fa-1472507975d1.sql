-- =====================================================
-- CHECKOUT ERROR FIX: Clean Function and Add Missing Columns
-- =====================================================

-- First, completely drop all versions of create_order_with_items function
DO $$
DECLARE
    func_record RECORD;
BEGIN
    -- Find all versions of the function and drop them
    FOR func_record IN 
...
-- Create the unified create_order_with_items function
