...
-- 2. Add rate limiting table for payment operations
...
CREATE INDEX IF NOT EXISTS idx_payment_rate_limits_lookup 
ON payment_rate_limits(identifier, operation, date_trunc('hour', window_start));
...
-- 4. Create payment security monitoring function
...
-- 5. Add production safety check function
