...
export const ProductForm = ({
  ...
  const costPrice = watchPrice > 0 ? (watchPrice / (1 + (watchVatRate || 7.5) / 100)) : 0;
  const vatAmount = watchPrice > 0 ? (watchPrice - costPrice) : 0;
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Price (Inclusive of VAT)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
                    ...
                    {watchPrice > 0 && (
                      <div className="text-xs text-muted-foreground mt-1 p-2 bg-muted rounded">
                        ...
                        <div className="font-medium">Total: ₦{watchPrice.toFixed(2)}</div>
                      </div>
                    )}
                  </FormItem>
                )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        placeholder="7.5"
                        {...field}
                        onChange={e => field.onChange(parseFloat(e.target.value) || 7.5)}
                      />
                    </FormControl>
                    <FormMessage />
                    <FormDescription>
                      Default VAT rate for Nigeria is 7.5%
                    </FormDescription>
                  </FormItem>
                )}
              />
