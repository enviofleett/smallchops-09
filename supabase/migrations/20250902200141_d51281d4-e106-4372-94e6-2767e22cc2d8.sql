...
-- Drop and recreate the upsert function to work with order_id instead of reference
DROP FUNCTION IF EXISTS public.upsert_payment_confirmation_event(text, text, uuid, jsonb);

CREATE FUNCTION public.upsert_payment_confirmation_event(
  p_reference text,
