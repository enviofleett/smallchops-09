-- Enhanced branding system database setup - Final version
...
CREATE TABLE IF NOT EXISTS public.upload_rate_limits (
  ...
  window_hour TIMESTAMPTZ DEFAULT date_trunc('hour', NOW())
);

-- Add unique constraint separately
ALTER TABLE public.upload_rate_limits DROP CONSTRAINT IF EXISTS upload_rate_limits_user_window_unique;
ALTER TABLE public.upload_rate_limits ADD CONSTRAINT upload_rate_limits_user_window_unique UNIQUE (user_id, window_hour);
