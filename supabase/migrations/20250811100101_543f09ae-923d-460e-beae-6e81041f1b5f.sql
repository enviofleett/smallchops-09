-- ========================================
-- 🚨 EMERGENCY PRODUCTION FIX - FUNCTION CLEANUP
-- Drop existing function and recreate with proper signature
-- ========================================

-- STEP 1: Drop existing handle_successful_payment function
DROP FUNCTION IF EXISTS handle_successful_payment CASCADE;

-- STEP 2: Fix Reference Format Standardization
...
-- STEP 4: Create NEW handle_successful_payment function
...
-- STEP 5: Emergency Backfill Function
