-- PHASE 1: Critical Configuration Fixes (Fixed Version)
-- =====================================================
...
('welcome', 'Customer Welcome Email', 
 ...
 'transactional', true, ARRAY['customer_name', 'business_name']),
...
('order_confirmation', 'Order Confirmation',
 ...
 'transactional', true, ARRAY['customer_name', 'order_id', 'total_amount']),
...
('order_status_update', 'Order Status Update',
 ...
 'transactional', true, ARRAY['order_id', 'status', 'status_message']),
...
('payment_confirmation', 'Payment Confirmation',
 ...
 'transactional', true, ARRAY['order_id', 'amount']),
...
('shipping_notification', 'Shipping Notification',
 ...
 'transactional', true, ARRAY['order_id', 'tracking_number', 'estimated_delivery']),
...
('cart_abandonment', 'Cart Abandonment Reminder',
 ...
 'marketing', true, ARRAY['customer_name', 'item_count', 'total_amount']),
...
('admin_order_notification', 'New Order Alert',
 ...
 'transactional', true, ARRAY['order_id', 'customer_name', 'customer_email', 'total_amount', 'item_count']),
...
('order_delivered', 'Order Delivered',
 ...
 'transactional', true, ARRAY['order_id']),
...
('welcome_series_day1', 'Welcome Series - Day 1',
 ...
 'marketing', true, ARRAY['customer_name', 'business_name']),
...
('review_request', 'How was your order?',
 ...
 'marketing', true, ARRAY['customer_name', 'order_id'])
