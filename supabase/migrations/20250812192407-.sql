-- Phase 1: Database Migration - Fix Payment References (Safe Version)
-- Convert all pay_ references to secure txn_ format without status changes

-- Update payment references for all orders with pay_ format without changing status
UPDATE orders 
SET 
