-- Phase 1: Database Foundation - Critical Fixes for Order Management System
...
-- 5. Recreate the constraint more safely
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_communication_events_dedupe_safe 
