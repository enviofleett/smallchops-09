...
DROP POLICY IF EXISTS "business_settings_production_admin_access" ON public.business_settings;
...
DROP POLICY IF EXISTS "business_sensitive_data_production_admin" ON public.business_sensitive_data;
...
DROP POLICY IF EXISTS "communication_settings_production_admin" ON public.communication_settings;
