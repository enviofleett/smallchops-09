            ...
            <div className="flex justify-center lg:justify-start">
              <div className="w-full max-w-sm bg-orange-50 p-6 rounded-2xl shadow-lg border border-orange-100">
                ...
                <div className="space-y-3">
                  <span className="text-sm text-gray-600 text-center lg:text-left block pb-1 border-b border-dotted border-red-400 bg-white px-3 py-2 rounded">5 Samosa</span>
                  <span className="text-sm text-gray-600 text-center lg:text-left block pb-1 border-b border-dotted border-red-400 bg-white px-3 py-2 rounded">5 Spring Rolls</span>
                  <span className="text-sm text-gray-600 text-center lg:text-left block pb-1 border-b border-dotted border-red-400 bg-white px-3 py-2 rounded">5 Stick Meat</span>
                  <span className="text-sm text-gray-600 text-center lg:text-left block pb-1 border-b border-dotted border-red-400 bg-white px-3 py-2 rounded">20 Poff-Poff</span>
                </div>
              </div>
            </div>
          </div>
